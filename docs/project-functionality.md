  ...
  - Кнопка "Выйти из аккаунта" — расположена в шапке сайта слева от ФИО пользователя. При нажатии на нее открывается окно подтверждения.

    ![Боковое меню](./images/log-out/header-logout.png)
